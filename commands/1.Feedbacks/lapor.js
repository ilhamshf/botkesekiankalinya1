...
exports.run = async (client, message, args) => {
  try {
    ...
    return message.channel.send(`Something went wrong: ${error.message} silahkan buat channel text dengan nama feedbacks`);
...
exports.help = {
  ...
  usage: 'k!lapor [isi]',
  example: '.lapor owner yang baik hati dan tydak sombong'
};